...
//        return trajectoryWaypoint();
  ...
  public Command groundPickupCommand(OI oi){ 
    ...
    ArrayList<Arm.JointWaypoints> coneWaypoints = new ArrayList<Arm.JointWaypoints>();
        ...
        coneWaypoints.add(m_arm.new JointWaypoints(-3.9, 2.9, -1.21, 4.0));
